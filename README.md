...
|----------|--------------|-------|
| [**Facial Emotion Recognition (FER) with Transfer Learning**](https://sarah-gakii.github.io/projects) | Currently building a deep learning model for facial emotion recognition using transfer learning, applying data augmentation, regularization, and training optimization to classify emotions from facial images. | Python, TensorFlow, Keras, Deep Learning, CNNs, Transfer Learning (VGG, ResNet, EfficientNet), Image Augmentation, Computer Vision |
